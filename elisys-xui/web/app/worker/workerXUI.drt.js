...
(function dartProgram() {
  ...
  G = {ClauseType: function ClauseType() {
    ...
    }, IdentifierToken: function IdentifierToken() {
  ...
  F = {MessageLevel: function MessageLevel() {
  ...
  L = {PreprocessorOptions: function PreprocessorOptions() {
  ...
  B = {CssPrinter: function CssPrinter() {
    }, Identifier: function Identifier() {
    }, Wildcard: function Wildcard() {
    }, ThisOperator: function ThisOperator() {
    ...
    }, SelectorGroup: function SelectorGroup() {
    }, Selector: function Selector() {
    }, SimpleSelectorSequence: function SimpleSelectorSequence() {
    }, SimpleSelector: function SimpleSelector() {
    }, ElementSelector: function ElementSelector() {
    }, NamespaceSelector: function NamespaceSelector() {
    }, AttributeSelector: function AttributeSelector() {
    }, IdSelector: function IdSelector() {
    }, ClassSelector: function ClassSelector() {
    }, PseudoClassSelector: function PseudoClassSelector() {
    }, PseudoElementSelector: function PseudoElementSelector() {
    }, PseudoClassFunctionSelector: function PseudoClassFunctionSelector() {
    }, PseudoElementFunctionSelector: function PseudoElementFunctionSelector() {
    }, SelectorExpression: function SelectorExpression() {
    }, NegationSelector: function NegationSelector() {
    }, NoOp: function NoOp() {
    ...
    }, OperatorPlus: function OperatorPlus() {
    }, OperatorMinus: function OperatorMinus() {
    }, UnicodeRangeTerm: function UnicodeRangeTerm() {
    }, LiteralTerm: function LiteralTerm() {
    }, NumberTerm: function NumberTerm() {
    }, UnitTerm: function UnitTerm() {
    }, LengthTerm: function LengthTerm() {
    }, PercentageTerm: function PercentageTerm() {
    }, EmTerm: function EmTerm() {
    }, ExTerm: function ExTerm() {
    }, AngleTerm: function AngleTerm() {
    }, TimeTerm: function TimeTerm() {
    }, FreqTerm: function FreqTerm() {
    }, FractionTerm: function FractionTerm() {
    }, UriTerm: function UriTerm() {
    }, ResolutionTerm: function ResolutionTerm() {
    }, ChTerm: function ChTerm() {
    }, RemTerm: function RemTerm() {
    }, ViewportTerm: function ViewportTerm() {
    ...
    }, _ConcatTextVisitor: function _ConcatTextVisitor() {
  ...
  V = {HtmlParser: function HtmlParser() {
    }, Phase: function Phase() {
    }, InitialPhase: function InitialPhase() {
    }, BeforeHtmlPhase: function BeforeHtmlPhase() {
    }, BeforeHeadPhase: function BeforeHeadPhase() {
    }, InHeadPhase: function InHeadPhase() {
    }, AfterHeadPhase: function AfterHeadPhase() {
    }, InBodyPhase: function InBodyPhase() {
    }, TextPhase: function TextPhase() {
    }, InTablePhase: function InTablePhase() {
    }, InTableTextPhase: function InTableTextPhase() {
    }, InCaptionPhase: function InCaptionPhase() {
    }, InColumnGroupPhase: function InColumnGroupPhase() {
    }, InTableBodyPhase: function InTableBodyPhase() {
    }, InRowPhase: function InRowPhase() {
    }, InCellPhase: function InCellPhase() {
    }, InSelectPhase: function InSelectPhase() {
    }, InSelectInTablePhase: function InSelectInTablePhase() {
    }, InForeignContentPhase: function InForeignContentPhase() {
    }, AfterBodyPhase: function AfterBodyPhase() {
    }, InFramesetPhase: function InFramesetPhase() {
    }, AfterFramesetPhase: function AfterFramesetPhase() {
    }, AfterAfterBodyPhase: function AfterAfterBodyPhase() {
    }, AfterAfterFramesetPhase: function AfterAfterFramesetPhase() {
    }, ParseError: function ParseError() {
    }, HtmlInputStream: function HtmlInputStream() {
  ...
  Z = {ElementCssClassSet: function ElementCssClassSet() {
    }, CssClassSet0: function CssClassSet0() {
    }, _CssClassSetImpl: function _CssClassSetImpl() {
    }},
  K = {EncodingBytes: function EncodingBytes() {
    }, _DispatchEntry: function _DispatchEntry() {
    }, EncodingParser: function EncodingParser() {
    }, ContentAttrParser: function ContentAttrParser() {
    }, PathMap: function PathMap() {
    }, UnicodeGlyphSet: function UnicodeGlyphSet() {
    }, XMLElemReader: function XMLElemReader() {
    }, XMLElem: function XMLElem() {
    }, HTMLReader: function HTMLReader() {
    },
    FileDesignInfo$: function(receiver) {
      return new K.FileDesignInfo();
    },
    SlotInfoJS: function SlotInfoJS() {
    },
    VueParamJS: function VueParamJS() {
    },
    Options: function Options() {
    },
    ObjectDesign: function ObjectDesign() {
    },
    FileDesignInfo: function FileDesignInfo() {
    },
    main: function() {
      var t1 = P.allowInterop(K.workerXUI__doEvent$closure(), {func: 1, ret: -1, args: [P.String]});
      $xui.doEvent = t1;
      P.print("((((((((((((((object)))))))))))))))))");
      J.$index$asx($.$get$context(), "$xuiworker").callMethod$2("doPromiseJS", H.setRuntimeTypeInfo(["setDesignProperties", "a"], [P.String]));
    },
    doEvent: function(json) {
      return K.doEvent$body(H.stringTypeCheck(json));
    },
    doEvent$body: function(json) {
      var $async$goto = 0,
        $async$completer = P._makeAsyncAwaitCompleter(null),
        fileInfo;
      var $async$doEvent = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              P.print(json);
              fileInfo = K.FileDesignInfo$(null);
              C.FileDesignInfo_methods.set$file(fileInfo, "app/frame1.html");
              C.FileDesignInfo_methods.set$xid(fileInfo, "root");
              P.print(C.FileDesignInfo_methods.get$xid(fileInfo));
              P.print(json);
              // implicit return
              return P._asyncReturn(null, $async$completer);
          }
      });
      return P._asyncStartSync($async$doEvent, $async$completer);
    }
  },
  T = {Token0: function Token0() {
    }, TagToken: function TagToken() {
    }, StartTagToken: function StartTagToken() {
    }, EndTagToken: function EndTagToken() {
    }, StringToken: function StringToken() {
    }, ParseErrorToken: function ParseErrorToken() {
    }, CharactersToken: function CharactersToken() {
    }, SpaceCharactersToken: function SpaceCharactersToken() {
    }, CommentToken: function CommentToken() {
    }, DoctypeToken: function DoctypeToken() {
    }, TagAttribute: function TagAttribute() {
    }, TokenKind0: function TokenKind0() {
    }, XUIActionManager: function XUIActionManager() {
    }, UndoAction: function UndoAction() {
    }, XUIDesignManager: function XUIDesignManager() {
    }, JSDesignInfo: function JSDesignInfo() {
    }},
  Y = {HtmlTokenizer: function HtmlTokenizer() {
    }, SourceFile: function SourceFile() {
    }, FileLocation: function FileLocation() {
    }, FileSpan: function FileSpan() {
    }, _FileSpan: function _FileSpan() {
    }, SourceSpanMixin: function SourceSpanMixin() {
    }, Provider: function Provider() {
    }, XUIContext: function XUIContext() {
    }, DicoOrdered: function DicoOrdered() {
    }, XUIResource: function XUIResource() {
    }, XUIEngine: function XUIEngine() {
    }, SlotInfo: function SlotInfo() {
    }, DocInfo: function DocInfo() {
    }, DocVariables: function DocVariables() {
    }, DesignInfo: function DesignInfo() {
    }},
  D = {ActiveFormattingElements: function ActiveFormattingElements() {
    }, TreeBuilder: function TreeBuilder() {
    }, SourceLocationMixin: function SourceLocationMixin() {
    }, XUIElement: function XUIElement() {
    }, XUIElementHTML: function XUIElementHTML() {
    }, XUIElementHTMLText: function XUIElementHTMLText() {
    }, XUIElementNative: function XUIElementNative() {
    }, XUIElementXUI: function XUIElementXUI() {
    }, XUIElementText: function XUIElementText() {
    }},
  N = {Pair: function Pair() {
    }},
  Q = {JS: function JS() {
    }, _Anonymous: function _Anonymous() {
    }, XUIHtmlBuffer: function XUIHtmlBuffer() {
    }, XUIComponent: function XUIComponent() {
    }, XUIDesign: function XUIDesign() {
    }, XUIChild: function XUIChild() {
    }, XUIModel: function XUIModel() {
    }},
  M = {Context: function Context() {
    }, _PathDirection: function _PathDirection() {
    }, _PathRelation: function _PathRelation() {
    }, ProviderAjax: function ProviderAjax() {
    }},
  X = {ParsedPath: function ParsedPath() {
  ...
  E = {PosixStyle: function PosixStyle() {
    ...
    }, XUIProperty: function XUIProperty() {
    }, ParseInfoMode: function ParseInfoMode() {
    }, ParseInfo: function ParseInfo() {
    }},
  U = {Highlighter: function Highlighter() {
    }},
  S = {BasicLock: function BasicLock() {
    }},
  A = {AsciiGlyphSet: function AsciiGlyphSet() {
    }, XUIParseJSDataBinding: function XUIParseJSDataBinding() {
    }, JSDataBindingProp: function JSDataBindingProp() {
    }},
  R = {NativeSlot: function NativeSlot() {
    }, NativeInjectFile: function NativeInjectFile() {
    }, NativeRegister: function NativeRegister() {
    }};
  var holders = [C, H, J, P, W, G, F, L, B, V, Z, K, T, Y, D, N, Q, M, X, O, E, U, S, A, R];
  ...
  J.JavaScriptObject.prototype = {
    ...
    $isObjectDesign: 1,
    $isFileDesignInfo: 1,
    set$xid: function(obj, v) {
      return obj.xid = v;
    },
    set$file: function(obj, v) {
      return obj.file = v;
    }
  };
  ...
  H.Symbol0.prototype = {
    ...
    $eq: function(_, other) {
      if (other == null)
        return false;
      return other instanceof H.Symbol0 && H.boolConversionCheck(J.$eq$(this.__internal$_name, other.__internal$_name));
    },
    $isSymbol: 1
  };
  ...
  P._symbolMapToStringMap_closure.prototype = {$signature: 6};
  ...
  P.JsObject.prototype = {
    ...
    callMethod$2: function(method, args) {
      ...
      t1 = this._jsObject;
      t2 = args == null ? null : P.List_List$from(J.map$1$1$ax(args, P.js___convertToJS$closure(), null), null);
  ...
  P.JsArray.prototype = {
    ...
    addAll$1: function(_, iterable) {
      ...
      this.callMethod$2("push", H.listTypeCheck(iterable instanceof Array ? iterable : P.List_List$from(iterable, null)));
    },
  ...
  B.Visitor.prototype = {$isVisitorBase: 1};
  B.AttributeName.prototype = {$isComparable: 1,
    $asComparable: function() {
    }
  };
  B._ParentNode.prototype = {$isNode0: 1};
  B._NonElementParentNode.prototype = {$is_ParentNode: 1, $isNode0: 1};
  B._ElementAndDocument.prototype = {$is_ParentNode: 1, $isNode0: 1};
  B.Node0.prototype = {};
  B.Document0.prototype = {$is_ParentNode: 1, $is_NonElementParentNode: 1, $is_ElementAndDocument: 1};
  B.DocumentFragment0.prototype = {$is_ParentNode: 1, $is_NonElementParentNode: 1};
  B.DocumentType.prototype = {};
  B.Text0.prototype = {};
  B.Element0.prototype = {$is_ParentNode: 1, $is_ElementAndDocument: 1};
  B.Comment1.prototype = {};
  B.NodeList0.prototype = {
    $asEfficientLengthIterable: function() {
      return [B.Node0];
    },
    $asListBase: function() {
  ...
  V.ParseError.prototype = {$isException: 1, $isSourceSpanException: 1};
  F.ReparseException.prototype = {$isException: 1};
  ...
  Y.HtmlTokenizer.prototype = {$isIterator: 1,
    $asIterator: function() {
      return [T.Token0];
    }
  };
  ...
  Y._FileSpan.prototype = {$isFileSpan: 1, $isSourceSpanBase: 1, $isSourceSpanWithContext: 1};
  U.Highlighter.prototype = {};
  V.SourceLocation0.prototype = {$isComparable: 1,
    $asComparable: function() {
      return [V.SourceLocation0];
    }
  };
  V.SourceLocationBase.prototype = {};
  D.SourceLocationMixin.prototype = {$isComparable: 1,
    $asComparable: function() {
      return [V.SourceLocation0];
    },
    $isSourceLocation0: 1
  ...
  Y.SourceSpanMixin.prototype = {$isComparable: 1,
    $asComparable: function() {
      return [V.SourceSpan];
    },
    $isSourceSpan: 1
  ...
  K.XMLElemReader.prototype = {};
  K.XMLElem.prototype = {};
  K.HTMLReader.prototype = {};
  M.ProviderAjax.prototype = {};
  T.XUIActionManager.prototype = {};
  T.UndoAction.prototype = {};
  T.XUIDesignManager.prototype = {};
  T.JSDesignInfo.prototype = {};
  D.XUIElement.prototype = {};
  D.XUIElementHTML.prototype = {};
  D.XUIElementHTMLText.prototype = {};
  D.XUIElementNative.prototype = {};
  D.XUIElementXUI.prototype = {};
  D.XUIElementText.prototype = {};
  Y.Provider.prototype = {};
  Y.XUIContext.prototype = {};
  Y.DicoOrdered.prototype = {};
  Y.XUIResource.prototype = {};
  Y.XUIEngine.prototype = {};
  Y.SlotInfo.prototype = {};
  Y.DocInfo.prototype = {};
  Y.DocVariables.prototype = {};
  Y.DesignInfo.prototype = {};
  Q.XUIHtmlBuffer.prototype = {};
  Q.XUIComponent.prototype = {};
  Q.XUIDesign.prototype = {};
  Q.XUIChild.prototype = {};
  Q.XUIModel.prototype = {$isComparable: 1,
    $asComparable: function() {
      return [Q.XUIModel];
    }
  };
  K.SlotInfoJS.prototype = {};
  K.VueParamJS.prototype = {};
  K.Options.prototype = {};
  K.ObjectDesign.prototype = {};
  K.FileDesignInfo.prototype = {};
  A.XUIParseJSDataBinding.prototype = {};
  A.JSDataBindingProp.prototype = {};
  E.XUIProperty.prototype = {};
  E.ParseInfoMode.prototype = {};
  E.ParseInfo.prototype = {};
  R.NativeSlot.prototype = {};
  R.NativeInjectFile.prototype = {};
  R.NativeRegister.prototype = {};
  (function aliases() {
  ...
  (function installTearOffs() {
    ...
    _static(P, "async___rootScheduleMicrotask$closure", 4, null, ["call$4"], ["_rootScheduleMicrotask"], 20, 0);
    _static_1(P, "js___convertToJS$closure", "_convertToJS", 2);
    _static_1(P, "js___convertToDart$closure", "_convertToDart", 21);
    _static_1(K, "workerXUI__doEvent$closure", "doEvent", 4);
  })();
  (function inheritance() {
    ...
    _inheritMany(J.JavaScriptObject, [J.PlainJavaScriptObject, J.UnknownJavaScriptObject, J.JavaScriptFunction, K.SlotInfoJS, K.VueParamJS, K.Options, K.ObjectDesign, K.FileDesignInfo]);
    ...
    _inheritMany(P.ListBase, [H.UnmodifiableListBase, H.FixedLengthListBase, W._ChildrenElementList, W.ElementList, W._FrozenElementList, W._ChildNodeListLazy, W._WrappedList, P.FilteredElementList, F.ListProxy]);
    ...
    _inheritMany(P.IterableBase, [H.LinkedList, H._AllMatchesIterable, P._SyncStarIterable, B._FilteredElementList_IterableBase_ListMixin, B.PathSet, L.InfiniteIterable, L.EnumerateIterable, L.GeneratingIterable, L._Merge, L._Partition]);
    ...
    _inheritMany(P.SetBase, [P.CssClassSetImpl, Z._CssClassSetImpl]);
    ...
    _inheritMany(B.Node0, [B._Document_Node__ParentNode, B._DocumentFragment_Node__ParentNode, B.DocumentType, B.Text0, B._Element_Node__ParentNode, B.Comment1]);
    ...
    _inherit(B.DocumentFragment0, B._DocumentFragment_Node__ParentNode__NonElementParentNode);
    _inherit(B._Element_Node__ParentNode__ElementAndDocument, B._Element_Node__ParentNode);
    _inherit(B.Element0, B._Element_Node__ParentNode__ElementAndDocument);
    _inheritMany(F.ListProxy, [B.NodeList0, D.ActiveFormattingElements]);
    ...
    _inherit(V.SourceLocationBase, V.SourceLocation0);
    _inherit(G.SourceSpanFormatException, G.SourceSpanException);
    _inherit(X.SourceSpanWithContext, V.SourceSpanBase);
    _inherit(M.ProviderAjax, Y.Provider);
    _inheritMany(D.XUIElement, [D.XUIElementHTML, D.XUIElementXUI]);
    _inherit(D.XUIElementHTMLText, D.XUIElementHTML);
    _inheritMany(D.XUIElementXUI, [D.XUIElementNative, D.XUIElementText]);
    _inherit(Y.XUIResource, K.XMLElemReader);
    _inheritMany(Q.XUIModel, [Q.XUIComponent, Q.XUIDesign, Q.XUIChild]);
    _inheritMany(D.XUIElementNative, [R.NativeSlot, R.NativeInjectFile]);
  ...
  var init = {mangledGlobalNames: {int: "int", double: "double", num: "num", String: "String", bool: "bool", Null: "Null", List: "List"}, mangledNames: {}, getTypeFromName: getGlobalFromName, metadata: [], types: [{func: 1, ret: P.Null}, {func: 1, ret: -1}, {func: 1, args: [,]}, {func: 1, ret: -1, args: [{func: 1, ret: -1}]}, {func: 1, args: [P.String]}, {func: 1, ret: P.Null, args: [,]}, {func: 1, ret: P.Null, args: [P.Symbol,,]}, {func: 1, ret: P.String, args: [P.int]}, {func: 1, ret: P.Null, args: [P.String,,]}, {func: 1, args: [, P.String]}, {func: 1, ret: P.Null, args: [{func: 1, ret: -1}]}, {func: 1, ret: -1, args: [,]}, {func: 1, ret: P.Null, args: [, P.StackTrace]}, {func: 1, ret: P.Null, args: [P.int,,]}, {func: 1, ret: P.Null, args: [,], opt: [P.StackTrace]}, {func: 1, ret: [P._Future,,], args: [,]}, {func: 1, ret: P.Null, args: [,,]}, {func: 1, ret: P.JsFunction, args: [,]}, {func: 1, ret: [P.JsArray,,], args: [,]}, {func: 1, ret: P.JsObject, args: [,]}, {func: 1, ret: -1, args: [P.Zone, P.ZoneDelegate, P.Zone, {func: 1, ret: -1}]}, {func: 1, ret: P.Object, args: [,]}], interceptorsByTag: null, leafTags: null};
  (function constants() {
    var makeConstList = hunkHelpers.makeConstList;
    C.FileDesignInfo_methods = K.FileDesignInfo.prototype;
...
//# sourceMappingURL=workerXUI.drt.js.map
