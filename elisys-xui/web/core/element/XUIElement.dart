...
class XUIElementHTML extends XUIElement
{
    ...
    dynamic searchPropertyXUI(String tag)
    {
        ...
        if (prop!=null)
          ...
          return parent.searchPropertyXUI(tag);
    }
    ...
    void toHTMLString(XUIHtmlBuffer buffer)
    {
        ...
        bool hasChidren = this.children?.firstWhere((c) => (c is! XUIElementHTMLText), orElse: ()=>  null)!=null;
 ...
 */
class XUIElementNative extends XUIElementXUI
{
      Function fctPhase1;
      Function fctPhase2;

      Future<XUIModel> doProcessPhase1(XUIResource xuifile, XUIElementHTML elemHtml)  {
         return fctPhase1(xuifile,this, elemHtml);
      }

      void doProcessPhase2(XUIResource xuifile, XUIElementHTML html) {
         if (fctPhase2!=null) fctPhase2(xuifile, this, html);
      }
}
